...
Choice_Simple::Choice_Simple(const char * name, const sf::Text & text_style, sf::Vector2f pos, std::function<Screens(const sf::RenderTarget&, Game_window&)> _Run, sf::Vector2f scale) :
...
Choice_Simple::Choice_Simple(const char * name, const sf::Text & text_style, float posX, float posY, std::function<Screens(const sf::RenderTarget&, Game_window&)> _Run, sf::Vector2f scale) :
