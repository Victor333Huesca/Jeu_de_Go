...
Choice_Simple::Choice_Simple(const wchar_t * name, const sf::Text & text_style, sf::Vector2f pos, std::function<Screens(sf::RenderTarget&, Go_Solver&)> _Run, sf::Vector2f scale) :
...
Choice_Simple::Choice_Simple(const wchar_t * name, const sf::Text & text_style, float posX, float posY, std::function<Screens(sf::RenderTarget&, Go_Solver&)> _Run, sf::Vector2f scale) :
