...
public:
    ...
    virtual int Run(sf::RenderWindow &window, Game_window& game);
...
private:
    ...
    int click(const sf::Mouse::Button& type, const sf::RenderWindow& window, Game_window& game);		// Renvoie la fenetre à charger et NO_CHANGE sinon 
